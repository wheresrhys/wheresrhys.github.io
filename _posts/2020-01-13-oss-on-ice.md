...
So, I think it'd be illuminating to show what goes into maintaining an open source project, even during the "quiet" periods. What are the forces that drag it away from a steady state?
